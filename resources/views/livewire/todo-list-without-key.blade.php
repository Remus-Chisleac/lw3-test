<div class="max-w-7xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-lg">
    ...
    <h2 class="text-2xl font-bold mb-4 text-red-600">WITHOUT wire:key (BROKEN)</h2>
                ...
                <div class="p-4 bg-red-50 border border-red-200 rounded-md">
                    ...
                    <ol class="text-sm text-red-700 space-y-2">
                        ...
                        <li class="flex items-start">
                            ...
                            <span>Notice the input values stay in wrong positions!</span>
                        </li>
                        <li class="flex items-start">
                            ...
                            <span>Delete an item and see how the state gets mixed up</span>
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div wire:ignore class="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-md ">
        ...
        <div class="mb-4">
            ...
            <pre class="text-sm bg-gray-900 text-gray-100 p-4 rounded border overflow-x-auto"><code class="language-php">class TodoListWithoutKey extends Component
{
    public $todos = [];
...
<pre class="text-sm bg-gray-900 text-gray-100 p-4 rounded border overflow-x-auto"><code class="language-php">&#64;foreach($todos as $index => $todo)
    ...
    &lt;/div&gt;
&#64;endforeach</code></pre>
            <p class="text-sm text-red-600 mt-2 font-medium">BROKEN: No wire:key attribute on the div!</p>
        </div>
    </div>
</div>
