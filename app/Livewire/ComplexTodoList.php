...
class ComplexTodoList extends Component
{
    ...
    {
        $this->todos = [
            ['id' => 1, 'text' => 'Learn Laravel with nested components', 'completed' => false],
            ['id' => 2, 'text' => 'Master Livewire wire:key with nesting', 'completed' => true],
            ['id' => 3, 'text' => 'Build complex nested apps', 'completed' => false],
            ['id' => 4, 'text' => 'Understand DOM state preservation', 'completed' => false],
        ];
    }
    ...
    {
        return view('livewire.complex-todo-list');
    }
}